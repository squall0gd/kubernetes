...
type EventReply struct {
	Error          string          `protobuf:"bytes,1,opt,name=error,proto3" json:"error,omitempty"`
	CgroupInfo     *CgroupInfo     `protobuf:"bytes,2,opt,name=cgroup_info,json=cgroupInfo" json:"cgroup_info,omitempty"`
	CgroupResource *CgroupResource `protobuf:"bytes,3,opt,name=cgroup_resource,json=cgroupResource" json:"cgroup_resource,omitempty"`
}
...
func (m *EventReply) MarshalTo(data []byte) (int, error) {
	...
	if m.CgroupResource != nil {
		data[i] = 0x1a
		i++
		i = encodeVarintApi(data, i, uint64(m.CgroupResource.Size()))
		n3, err := m.CgroupResource.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n3
...
func (m *EventReply) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.CgroupResource == nil {
				m.CgroupResource = &CgroupResource{}
			}
			if err := m.CgroupResource.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorApi = []byte{
	...
	,
}
